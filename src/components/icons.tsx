...
export function PhoneIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M6.5 3.5h3l1.5 4-2 1.5a12 12 0 0 0 6 6l1.5-2 4 1.5v3c0 .8-.5 1.5-1.3 1.6C10.8 20.2 3.8 13.2 2.9 4.8c-.1-.8.6-1.3 1.4-1.3Z" />
    </svg>
  );
}
